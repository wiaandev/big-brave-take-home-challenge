  ...
  return (
    <div className={style.container}>
        ...
        <div className={style.right}>
            ...
            <p>Want to know what type of character you are? Click on this cool looking button below</p>
            ...
            <Link to={"/form"}><Button text="Let's Start" type="primary" onClick={onNavigateToForm()}/></Link>
        </div>
    </div>
  )
}

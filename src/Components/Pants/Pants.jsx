...
function Pants({color, pantsStyle}) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 191.33 432.07" className={pantsStyle}>
      <defs>
        <style>{`.cls-1{fill:${color};}.cls-2{fill:#fde0e5;}.cls-3{fill:#c16e5e;}.cls-4{fill:#fee8ec;}.cls-5{fill:${color};}.cls-6{fill:#feedf1;}.cls-7{fill:#feebef;}.cls-8{fill:#bd6655;}`}</style>
      </defs>
      <g id="Layer_2" data-name="Layer 2">
        <g id="Layer_1-2" data-name="Layer 1">
          ...
          />
          <path className="cls-2" d="M147,386.72l-1.37.17c0-2.07.09-4.13.14-6.2Z" />
          <path
            className="cls-7"
